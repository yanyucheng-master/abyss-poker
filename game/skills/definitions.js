...
const SKILL_DEFINITIONS = Object.freeze({
  ...
  LOAN: freezeSkill({
    ...
    shortDescription: "可以借筹码或借能量。筹码贷款立刻拿走 100，下一手结束要还 150；能量贷款立刻多 5 点，下一手结束要还 6 点。",
    expertDescription: "主动/资源。负载 2，费用 2。分支必须在扣费前锁定。筹码贷款与能量贷款可以同时存在。同一手：能量贷款最多 1 次，筹码贷款最多 2 次。任意偿还失败形成的筹码债务或能量债务未清偿时，整个贷款技能封禁，不再区分债务类型。筹码贷款为公开：每次立即从对手取得 100 筹码，下一手结束偿还 150；同一手第二次筹码贷款会再取得 100 并再欠 150，两笔按各自到期分别偿还。若对手当前筹码 ≤100，取得其全部剩余筹码并完成贷款斩杀；偿还时若自己因此归零，同样可以斩杀自己。能量贷款为秘密：支付 2 后立即获得 5 能量且不突破个人上限，下一手结束偿还 6；不足时先扣当前能量，剩余形成能量债务，之后任何能量收入优先偿债。公平可清除尚未履行或尚未偿清的贷款债务，但不回滚已经取得的筹码或能量。若整场比赛已经依法结束，房间内所有尚未到期或尚未清偿的贷款债务直接失效。伪装生效时公开贷款只宣布发动行为，不公布任何筹码或债务数字。",
  }),
  ALERT: freezeSkill({
